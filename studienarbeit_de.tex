...
Die Pfadausrichtung und die Querabweichung werden dann an den Stanley-Regler eingegeben,
...
\begin{figure}[h]
    ...
    des Schachbretts sind gerade nach dem Verzeichnungkorrektur.} 
    \label{checkerboards}
\end{figure}
...
der Wert bei $K_{\mathrm{n},3, 3}$ auf 1 gesetzt werden. Die resultierende intrinsische
